...
import { canRead, enforceSyncSafety, extractionCacheKey, InMemoryEventStore, materializeApiSemantics, planBlockSync, propagateDirty, resolveEvidence, validateMutation } from "./index.js";
